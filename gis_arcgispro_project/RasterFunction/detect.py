...
class Detect():
    ...
    def updatePixels(self, tlc, size, props, **pixelBlocks):
        ...
        boxes=np.load("C:\\Users\\albe9057\\Documents\\ANieto_SolutionEngineering\\Projects\\EPA\\ArcGISPythonAPI_for_EPA\\Outputs\\boxes.npy") # shape (1,100,4)
        boxes=boxes[0] # (100,4)
        scores=np.load("C:\\Users\\albe9057\\Documents\\ANieto_SolutionEngineering\\Projects\\EPA\\ArcGISPythonAPI_for_EPA\\Outputs\\scores.npy") # shape (1,100)
        scores=scores[0] # (100)
